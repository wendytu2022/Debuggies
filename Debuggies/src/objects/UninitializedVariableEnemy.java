...
public class UninitializedVariableEnemy extends Enemy {
	private static final float ShotDelay = 3f;
	protected float timeBetweenShots = 3;
	
	public UninitializedVariableEnemy() {
		super(Team.Enemy, 100, EnemyErrorType.UninitializedVar);
		
		this.sprite = ImageManager.getImage("ghost_green_bug.png");
